...
INSERT INTO members (login_id, password_hash, nickname, user_type) VALUES
                                                                       ('student1',     'hashed_pass_capacity_test_1111111111111111', '김수강', 'STUDENT'),
...
INSERT INTO admins (admin_id, password_hash) VALUES
    ('super_admin', 'hashed_admin_pass_200_characters_capacity_test_999999999');

-- [Courses] 대용량 페이지네이션용 강의 데이터 (총 25개)
INSERT INTO courses (title, instructor_id, description, capacity, status) VALUES
                                                                              ('Java 웹 개발 마스터 클래스',         3, '자바 백엔드 개발자의 필수 코스입니다.',             30,  'PUBLIC'),
...
INSERT INTO enrollments (student_id, course_id, status, progress_rate) VALUES
                                                                           (1, 1,  'ACTIVE',   66),  -- 수강중 (3강 중 2강 완료)
                                                                           ...
                                                                           (2, 14, 'CANCELED',  0);  -- 수강 취소 내역


-- [Contents] 주차별 컨텐츠 데이터 (총 14개)
-- 1번 강의 (Java)
INSERT INTO contents (content_title, course_id, order_index) VALUES
                                                                 ('1강: 개발 환경 세팅 및 Hello World',   1, 1),
                                                                 ('2강: 변수와 제어문 마스터하기',         1, 2),
                                                                 ('3강: 객체지향 프로그래밍의 이해',       1, 3);

-- 2번 강의 (MySQL)
INSERT INTO contents (content_title, course_id, order_index) VALUES
                                                                 ('1강: 데이터베이스 개요 및 설치',              2, 1),
                                                                 ('2강: DDL, DML 쿼리 뽀개기',                  2, 2),
                                                                 ('3강: 서브쿼리와 조인(JOIN) 성능 최적화',      2, 3);

-- 3번 강의 (Spring Boot)
INSERT INTO contents (content_title, course_id, order_index) VALUES
                                                                 ('1강: 스프링 프레임워크 vs 스프링 부트',   3, 1),
...
INSERT INTO content_histories (enrollment_id, content_id, is_completed, last_date) VALUES
